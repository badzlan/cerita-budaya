            ...
            <div className="flex flex-wrap items-center -mx-4">
               <div className="w-full px-4">
                  <div className="text-center">
                     <h1 className="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[40px] md:leading-[1.2]">Jelajahi Cerita Nusantara</h1>
                     <p className="mb-5 text-base text-body-color">Lorem ipsum dolor, sit amet consectetur adipisicing elit. At alias explicabo dignissimos.</p>
