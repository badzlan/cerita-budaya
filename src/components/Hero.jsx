               ...
               <div className="w-full px-4">
                  <div className="hero-content mx-auto max-w-[780px] text-center">
                     ...
                     <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                        Cerita<span style={{ color: "#f1c28b" }}>Budaya</span> merupakan platform pembelajaran tentang cerita rakyat dari berbagai daerah di Indonesia dan dilengkap dengan Map Interaktif, Quiz, dan Virtual Tour.
                     </p>
